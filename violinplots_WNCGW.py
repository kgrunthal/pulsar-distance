...
def main():
    ...
    ###########################################################################
    ###########################################################################
    outdir_maxLH = './out/maxLH/'
    
    OS_95_08 = np.loadtxt(outdir_maxLH + 'OS_spectrum_WNCGW9.5_zeta0.8_2.txt').transpose()
    ...
    ###########################################################################
    ###########################################################################
    outdir_nm = './out/noisemarginalised/'
    
    data95_08 = np.loadtxt(outdir_nm + 'OS_spectrum_WNCGW9.5_zeta0.8_NM_2.txt').transpose()
    ...
    #-- logMc = 9.5 -----------------------------------------------------------
    fig_95, axs_95 = plt.subplots(nrows=1, ncols=2, figsize=(14, 5))
    plt.subplots_adjust(wspace=0.05)
    axs_95[1].yaxis.set_label_position("right")
    axs_95[1].yaxis.tick_right()
    ...
    plt.suptitle('log Mc = 9.5', fontsize=18)
    ...
    #-- logMc = 9.0 -----------------------------------------------------------
    fig_90, axs_90 = plt.subplots(nrows=1, ncols=2, figsize=(14, 5))
    plt.subplots_adjust(wspace=0.05)
    axs_90[1].yaxis.set_label_position("right")
    axs_90[1].yaxis.tick_right()
    ...
    #-- logMc = 8.5 -----------------------------------------------------------
    fig_85, axs_85 = plt.subplots(nrows=1, ncols=2, figsize=(14, 5))
    plt.subplots_adjust(wspace=0.05)
    axs_85[1].yaxis.set_label_position("right")
    axs_85[1].yaxis.tick_right()  

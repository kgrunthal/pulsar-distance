...
#for dset in low mid high; do
#for dset in over1.0 over1.5 over2.0; do
for dset in low mid; do

    MCMC_OUTDIR=/u/kgrunthal/HD/MCMCout_IPTA_CGW$lmc\_$dset\_$i\/
    NAME=CGW_$lmc\_$dset
    ...
    sbatch -p long.q --time=05:00:00 --mem=20GB --output=$MCMC_OUTDIR/slurm_output/CGW_noPT.out --error=$MCMC_OUTDIR/slurm_output/CGW_noPT.err --job-name=$NAME --wrap="singularity exec -B /scratch/kgrunthal/,/hercules/results/kgrunthal/,/u/kgrunthal/ /u/kgrunthal/EPTA_ENTERPRISE.sif python3 CGW_search.py --basedir $MCMC_OUTDIR --outdir $RESULT_DIR_noPT --ptamodel TM,WN,CGW --analysis --use_distance"
...
#    singularity exec -B /scratch/kgrunthal/,/hercules/results/kgrunthal/,/u/kgrunthal/ /scratch/kgrunthal/MPTA_singularity/ python3 CGW_search.py --basedir $MCMC_OUTDIR --outdir $RESULT_DIR_noPT --ptamodel TM,WN,CGW --psrTerm --analysis --use_distance --Nsample 50000 --sample_pdist

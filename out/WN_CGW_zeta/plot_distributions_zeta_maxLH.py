# -*- coding: utf-8 -*-
"""
Created on Wed Dec  4 11:41:32 2024
...
for ll, lmc in enumerate([8.5, 9.0, 9.5]):
    ...
    for dd, zeta in enumerate([1.0, 0.9, 0.8]):
        ...
        for i in range(realisations):
            print('... on lmc {}, zeta {}, realisation {}'.format(lmc, zeta, i), end='\r')
            run_dir = 'run_{}/maxLH/'.format(i+1)
            
            test = np.loadtxt(run_dir + 'OS_spectrum_CGW{}_zeta{}.txt'.format(lmc, zeta)).transpose()
            OSarray[i] = test[1]
